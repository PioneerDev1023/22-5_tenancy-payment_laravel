                ...
                <div class="row">
                    <div class="col-md-6 m-auto">
                        <div class="card p-4">
                            ...
                            <div class="form-group">
                                {{ Form::label('contact_us_email', __('Contact Us Email')) }}
                                <div class="input-group">

                                    {!! Form::text('contact_us_email', Utility::getsettings('contact_us_email') , ['class' => 'form-control', 'placeholder' => __('Enter contact us email')]) !!}
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div id="captcha_setting"
                                class="{{ Utility::getsettings('captcha_status') ? 'block' : 'd-none' }}">
                                <div class="form-group">
