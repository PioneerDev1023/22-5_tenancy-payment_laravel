                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="stripe_key" class="form-control"
                                                    value="{{ (Auth::user()->type == 'Admin')?Utility::getsettings('STRIPE_KEY'):env('STRIPE_KEY') }}" required
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="stripe_secret" class="form-control"
                                                    value="{{ (Auth::user()->type == 'Admin')?Utility::getsettings('STRIPE_SECRET'):env('STRIPE_SECRET') }}" required
