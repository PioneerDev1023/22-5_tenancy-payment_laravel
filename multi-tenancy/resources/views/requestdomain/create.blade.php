            ...
            <form method="POST" id="request_form" action="{{ route('requestdomain.store') }}">
                @csrf
                    <div class="form-group ">
                        ...
                        <input id="name" type="text" class="form-control" name="name" placeholder="{{ __('Enter name') }}" required autocomplete="name" autofocus>
                    </div>
                    <div class="form-group">
                        <label for="email">{{ __('Email') }}</label>
                        <input id="email" type="email" class="form-control" name="email" placeholder="{{ __('Enter email') }}" required autocomplete="email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="password2" class="d-block">{{ __('Password Confirmation') }}</label> <input
                            id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="{{ __('Enter confirm password') }}" required
