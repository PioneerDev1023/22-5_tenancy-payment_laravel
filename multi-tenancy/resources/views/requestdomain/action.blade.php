    ...
    <div class="dropdown d-inline">
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item text-success "
                href="{{ route('requestdomain.approve.status', $requestdomain->id) }}">
            ...
            {!! Form::open(['method' => 'DELETE', 'route' => ['requestdomain.delete', $requestdomain->id], 'id' => 'delete-form-' . $requestdomain->id]) !!}
            {!! Form::close() !!}
        </div>
    </div>
