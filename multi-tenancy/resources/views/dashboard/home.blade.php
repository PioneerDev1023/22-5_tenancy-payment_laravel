    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="row">
                ...
                @endif
                @if (tenant('id') != null)
                    @if ((!\App\Facades\UtilityFacades::getsettings('STRIPE_KEY') || !\App\Facades\UtilityFacades::getsettings('STRIPE_SECRET')) && (Auth::user()->type == 'Super Admin' || Auth::user()->type == 'Admin'))
                        <div class="col-md-12">
                            <br>
                            <div class="alert alert-warning">{{ __('Please Set your Stripe key & Stripe Secret') }} - <a
                                    href="{{ route('setting', 'stripe-setting') }}">{{ __('Click') }}</a> </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="card card-statistic-1">
                            ...
                            <div class="card-wrap">
                                ...
                                <div class="card-body">
                                    {{ Utility::getsettings('currency_symbol') . ' ' . $earning }}
                                </div>
                            </div>
                        </div>
                    </div>
